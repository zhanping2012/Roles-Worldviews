...
* 进入Roles-Worldviews的[`Roles分支树`](https://github.com/XuJing-project/Roles-Worldviews/tree/master/Roles)，点击[`+`](https://github.com/XuJing-project/Roles-Worldviews/new/master/Roles)号新建角色，然后看到如下一行字。
  * Roles-Worldviews / Roles`角色名/readme.md`or cancel
* 角色自助登记
